...
var gKeyboard = (function(window, document, undefined) {
 ...
 setShape(STORAGE.getItem('kbShape') || 'pc105');
  ...
  function setShape(value) {
   ...
   /*   
      document.getElementById('key_AD01').className = 'left5';
      document.getElementById('key_AD02').className = 'left4';
      document.getElementById('key_AD03').className = 'left3';
      document.getElementById('key_AD04').className = 'left2';
      document.getElementById('key_AD05').className = 'left2';
      document.getElementById('key_AD06').className = 'right2';
      document.getElementById('key_AD07').className = 'right2';
      document.getElementById('key_AD08').className = 'right3';
      document.getElementById('key_AD09').className = 'right4';
      document.getElementById('key_AD10').className = 'right5';
      document.getElementById('key_AD11').className = 'right5';
      document.getElementById('key_AD12').className = 'right5';
      document.getElementById('key_BKSL').className = 'right5';
      
      document.getElementById('key_AC01').className = 'left5';
      document.getElementById('key_AC02').className = 'left4';
      document.getElementById('key_AC03').className = 'left3';
      document.getElementById('key_AC04').className = 'left2';
      document.getElementById('key_AC05').className = 'left2';
      document.getElementById('key_AC06').className = 'right2';
      document.getElementById('key_AC07').className = 'right2';
      document.getElementById('key_AC08').className = 'right3';
      document.getElementById('key_AC09').className = 'right4';
      document.getElementById('key_AC10').className = 'right5';
      document.getElementById('key_AC11').className = 'right5';
      
      document.getElementById('key_AB01').className = 'left5';
      document.getElementById('key_AB02').className = 'left4';
      document.getElementById('key_AB03').className = 'left3';
      document.getElementById('key_AB04').className = 'left2';
      document.getElementById('key_AB05').className = 'left2';
      document.getElementById('key_AB06').className = 'right2';
      document.getElementById('key_AB07').className = 'right2';
      document.getElementById('key_AB08').className = 'right3';
      document.getElementById('key_AB09').className = 'right4';
      document.getElementById('key_AB10').className = 'right5'; */
